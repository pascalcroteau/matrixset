...
test_that("matrixset extraction works", {
  ...
  lst12 <- list(a = methods::as(methods::as(Matrix::Matrix(3),
                                            "generalMatrix"), "unpackedMatrix"),
                b = methods::as(methods::as(Matrix::Matrix(103),
                                            "generalMatrix"), "unpackedMatrix"), c = NULL)
...
test_that("grouped matrixset extraction works for Matrix", {
  ...
  lst12 <- list(a = methods::as(methods::as(Matrix::Matrix(5), "generalMatrix"),
                                "unpackedMatrix"),
                b = methods::as(methods::as(Matrix::Matrix(105), "generalMatrix"),
                                "unpackedMatrix"), c = NULL)
  rownames(lst12$a) <- rownames(lst12$b) <- "r1"
  colnames(lst12$a) <- colnames(lst12$b) <- "c2"
...
test_that("matrixset extraction warns properly for Matrix", {
  ...
  # lst12 <- list(a = methods::as(Matrix::Matrix(3), "dgeMatrix"),
  #               b = methods::as(Matrix::Matrix(103), "dgeMatrix"), c = NULL)
  lst12 <- list(a = methods::as(methods::as(Matrix::Matrix(3), "generalMatrix"),
                                "unpackedMatrix"),
                b = methods::as(methods::as(Matrix::Matrix(103), "generalMatrix"),
                                "unpackedMatrix"), c = NULL)
