...
test_that("matrixset extraction works", {
  ...
  lst1 <- list(a = matrix(seq(1,5,2),1,3), b = matrix(seq(101,105,2),1,3), c = NULL)
  lst2 <- list(a = matrix(3:4,2,1), b = matrix(103:104,2,1), c = NULL)
  lst12 <- list(a = matrix(3), b = matrix(103), c = NULL)
  lst1213 <- list(a = matrix(c(1,2,5,6),2,2), b = matrix(c(101,102,105,106),2,2), c = NULL)
...
test_that("grouped matrixset extraction works", {

  lst <- list(a = matrix(1:24, 4, 6), b = matrix(101:124, 4, 6), c = NULL)
  lst1 <- list(a = matrix(seq(1,21,4),1,6), b = matrix(seq(101,121,4),1,6), c = NULL)
  lst2 <- list(a = matrix(5:8,4,1), b = matrix(105:108,4,1), c = NULL)
  lst12 <- list(a = matrix(5), b = matrix(105), c = NULL)
  rownames(lst12$a) <- rownames(lst12$b) <- "r1"
  colnames(lst12$a) <- colnames(lst12$b) <- "c2"
  lst1213 <- list(a = matrix(c(1,2,9,10),2,2), b = matrix(c(101,102,109,110),2,2), c = NULL)
  rownames(lst1$a) <- rownames(lst1$b) <- "r1"
...
test_that("matrixset extraction warns properly", {
...
test_that("matrixset extraction reports errors properly", {
