...
only a single matrix, because several methods have been developped to manipulate
...
There is one last method to provide annotation: `annotate_row_from_matrix()`/
`annotate_column_from_matrix()`. With this method, a matrix operation (for 
